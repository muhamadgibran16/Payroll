    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            ...
            <div class="card mx-auto" style="width:400px;">
                ...
                <form action="<?= base_url('admin/slipGaji/cetakSlip');?>" method="POST">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row g-3 align-items-center">
                                <div class="col-3">
                                    <label for="inputPassword6" class="col-form-label">Nama Karyawan</label>
                                </div>
                                <div class="col-9">
                                    <select class="form-control ms-2" name="nama_karyawan" id="">
